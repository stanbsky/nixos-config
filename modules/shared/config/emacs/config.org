...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Stan Borzhemsky"
    user-mail-address "stanbsky@protonmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/stanborzhemsky/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/stanborzhemsky/bin" "/profile/bin" "/Users/stanborzhemsky/.npm-packages/bin" "/Users/stanborzhemsky/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
